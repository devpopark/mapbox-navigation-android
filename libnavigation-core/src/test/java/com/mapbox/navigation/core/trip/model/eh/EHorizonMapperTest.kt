...
class EHorizonMapperTest {
    ...
    fun `mapToEHorizonResultType should convert to types`() {
        val initial = EHorizonMapper.mapToEHorizonResultType(ElectronicHorizonResultType.INITIAL)
        val update = EHorizonMapper.mapToEHorizonResultType(ElectronicHorizonResultType.UPDATE)

        assertEquals(EHorizonResultType.INITIAL, initial)
        assertEquals(EHorizonResultType.UPDATE, update)
    }
