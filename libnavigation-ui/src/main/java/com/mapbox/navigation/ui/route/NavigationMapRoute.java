...
import static com.mapbox.navigation.ui.internal.utils.ViewUtils.dpToPx;
...
public class NavigationMapRoute implements LifecycleObserver {
  ...
  private NavigationMapRoute(@Nullable MapboxNavigation navigation,
    ...
    this.routeClickPadding = dpToPx(mapView.getContext(), routeClickPadding);
  ...
  public static class Builder {
     ...
     *
     * Passing a large integer values through this method means that a user doesn't
     ...
     * box's area are high. A smaller rectangle will decrease the chances.
     *
     * A device independent pixel value will be calculated based on the input padding provided.
     *
     * @return the builder
     */
    @NonNull
